...
L["Put on the bar"] = "Pôr na barra"
L["The preset's macro goes to your cursor: click an action bar slot to place it."] = "A macro do conjunto vai para o cursor: clique num espaço da barra de ações para colocá-la."
L["The macro is on your cursor: click a slot on your action bar."] = "A macro está no cursor: clique num espaço da barra de ações."
